...
const Rd = () =>
    $e.jsx("section", {
      ...
      children: $e.jsxs("div", {
        ...
        children: [
          $e.jsx("h1", { children: "Новинки від Narurehike" }),
          $e.jsx("p", {
            children:
              "Ассортимент Naturehike имеет большое разнообразие: палатки; спальные мешки; матрасы; гамаки; одежда для туризма; рюкзаки; походная посуда.",
          }),
          $e.jsx("a", { href: "", children: "Перейти" }),
          $e.jsx("h1", { children: "ewfwewdwedwe" }),
        ],
      }),
    }),
  Od = () => $e.jsx(Rd, {});
Wl.createRoot(document.getElementById("root")).render(
  $e.jsx(gc.StrictMode, { children: $e.jsx(Od, {}) })
);
